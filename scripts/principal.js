...
var ServicioDatosSolicitudes = 'http://localhost/vacay/general/BaseDatos/obtener_solicitudes.php';
var ServicioGrabarDatosSolicitud = 'http://localhost/vacay/general/BaseDatos/grabar_solicitud.php';
var ServicioEliminarDatosSolicitud = 'http://localhost/vacay/general/BaseDatos/eliminar_solicitud.php';
var ServicioDatosPersona = 'http://localhost/vacay/general/BaseDatos/obtener_datos_persona.php';
        ...
        if (data.length > 0) {
            ...
            data.forEach(function(solicitud) { 
                ...
                grilla +=   '<tr class="borde-tabla" style="color:'+color+'">'+
                                '<td style="padding-left:5px; width:100px;">'+solicitud.id+'</td>'+ 
                                '<td style="padding-left:5px; width:100px;">'+solicitud.persona_id+'</td>'+
                                '<td style="padding-left:5px; width:100px;">'+solicitud.nombre+'</td>'+
                                '<td style="padding-left:5px; width:200px;">'+solicitud.fecha_desde+'</td>'+
                                '<td style="padding-left:5px; width:200px;">'+solicitud.fecha_hasta+'</td>'+
                                '<td style="padding-right:5px; width:100px;">'+solicitud.estado+'</td>';
