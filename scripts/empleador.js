...
var ServicioDatosSectores = 'http://localhost/vacay/general/BaseDatos/cargar_sectores.php';
var ServicioDatosSolicitudes = 'http://localhost/vacay/general/BaseDatos/solicitudes_empleador.php';
var ServicioActualizarEstadoSolicitud = 'http://localhost/vacay/general/BaseDatos/actualizar_estado_solicitud.php';
...
function obtener_solicitudes_empleador(sector_id)
{
    ...
    $.ajax({
        ...
        if (data.length > 0) {
            ...
            $("#mensaje").text("Se encontraron " + data.length + " solicitudes");
